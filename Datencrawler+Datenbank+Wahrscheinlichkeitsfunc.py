...
def Gewinnwahscheinlichkeit (Team1, Team2):
    SiegTeam1 = 0
...
class GUI:
    def __init__(self):
        ...
        var1 = tk.StringVar()
        self.dropdown1 = tk.OptionMenu(self.Window, var1, mannschaften[0], mannschaften[1], mannschaften[2],
        ...
        # var1.get()
        var2 = tk.StringVar()
        self.dropdown2 = tk.OptionMenu(self.Window, var2, mannschaften[0], mannschaften[1], mannschaften[2],
                                       mannschaften[3], mannschaften[4], mannschaften[5], mannschaften[6],
                                       mannschaften[7], mannschaften[8], mannschaften[9], mannschaften[10],
                                       mannschaften[11], mannschaften[12], mannschaften[13], mannschaften[14],
                                       mannschaften[15], mannschaften[16], mannschaften[17])
    ...
    def predict(self):
        a = Gewinnwahscheinlichkeit (self.dropdown1,self.dropdown2)
        wkt = str(a)
